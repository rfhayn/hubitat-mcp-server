...
echo "  Find them at: http://<hub-ip>/apps → Maker API"
echo ""
echo "  If you haven't set up Maker API yet:"
echo "  1. Go to Apps → Add Built-in App → Maker API"
echo "  2. Select the devices you want to control"
echo "  3. Enable 'Allow control of modes' and 'Allow control of HSM'"
echo "  4. Copy the App ID and Access Token from the API page"
echo ""
